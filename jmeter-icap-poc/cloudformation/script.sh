...
sudo JVM_ARGS="-Xms9216m -Xmx9216m" sh jmeter.sh -n -t ICAP-POC_s3.jmx -Jp_bucket=aws-testengine-s3 -Jp_influxHost=10.112.0.112 -Jp_vuserCount=4000 -Jp_rampup=300 -Jp_duration=900 -Jp_url=gw-icap01.westeurope.azurecontainer.io -Jp_aws_access_key=AKIAU7264MESEFR5OH3A -Jp_aws_secret_k$
